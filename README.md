...
```
```json
{ "action": "extractFromPhoto", "photo_data_url": "data:image/jpeg;base64,..." }
```
...
- Auto-remplissage des champs à partir de la photo (OCR).
...
- Activer le service avancé **Drive API v2** dans Apps Script pour l'action OCR `extractFromPhoto`.
